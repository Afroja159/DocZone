...
class RequestedBloodUserProfile extends StatefulWidget {
  final String requestedUserId;

  RequestedBloodUserProfile({required this.requestedUserId});
...
class _RequestedBloodUserProfileState extends State<RequestedBloodUserProfile> {
  UserModel? userData;
